...
/*print number in hex begining with zero*/
...
/*print the number in octal begining with zero*/
...
/*prints number in uppercase hex*/

/**
 * printnumupx - prints number in uppercase hex.
 * @arguments: input string.
 * @buf: buffer pointer.
 * @ibuf: index for buffer pointer.
 * Return: number of chars printed.
